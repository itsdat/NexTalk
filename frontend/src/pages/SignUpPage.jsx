...
const SignUpPage = () => {
    ...
    const {signup, isSigningUp} = useAuthSrore()
        ...
        <div className='min-h-screen grid lg:grid-cols-2'>
            <div className='flex flex-col justify-center items-center p-6 sm:p-12'>
                <div className='w-full max-w-md space-y-8'>
                    <div className='text-center mb-8'>
                        <div className='flex flex-col items-center gap-2 group'>
                            ...
                            <p className='text-base-content/60'>Get started width your free account</p>
                        </div>
                    </div>
             ...
             <AuthImagePattern 
                    ...
                    subtitle="Connect with friends, share your favorite moments, and make every memory special."
            />
        </div>
    );
};
